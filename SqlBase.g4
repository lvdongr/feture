 ...
 */
 ...
 /*
  * 以下是基于Apache Spark 2.0.2版本修改的修改记�?
  * 公司名称：深圳市中兴通讯股份有限公司
  * 修改人：欧阳晓晨
  * 修改记录1：去�?kw1=ALTER kw2=TABLE tableIdentifier partitionSpec? kw3=ADD kw4=COLUMNS【测试alter table add columng功能�?
  * 修改记录2：spark2.0.2支持create external table if not exists gen_tbl like src_tbl，实际该表还是内部表【spark升级需要合入版本�?
  */
